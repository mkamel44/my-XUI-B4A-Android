...
mostCurrent._activity.LoadLayout("Layout",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="cur = Starter.sql.ExecQuery(\"select * from table1";
mostCurrent._cur = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("select * from table1")));
 //BA.debugLineNum = 29;BA.debugLine="cur.Position = 0";
mostCurrent._cur.setPosition((int) (0));
 //BA.debugLineNum = 30;BA.debugLine="Activity.Title = cur.GetString(\"name\")";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._cur.GetString("name")));
 //BA.debugLineNum = 31;BA.debugLine="cur.Close";
